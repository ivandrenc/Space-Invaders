...
public class EndScreenBackground extends Entity {
    ...
    public void onDraw(PaintBrush brush) {
        ...
        brush.drawImage(position, size, Sprite.END_BACKGROUND);
        brush.drawImage(Background2, size, Sprite.END_BACKGROUND);
    }
}
